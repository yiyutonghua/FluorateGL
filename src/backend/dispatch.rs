...
pub struct GlesDispatch {
    ...
    pub sampler_parameter_i_iv: unsafe extern "C" fn(u32, u32, *const i32),
    pub sampler_parameter_i_uiv: unsafe extern "C" fn(u32, u32, *const u32),
    pub get_sampler_parameter_iv: unsafe extern "C" fn(u32, u32, *mut i32),
    pub get_sampler_parameter_fv: unsafe extern "C" fn(u32, u32, *mut f32),
    pub get_sampler_parameter_i_iv: unsafe extern "C" fn(u32, u32, *mut i32),
    pub get_sampler_parameter_i_uiv: unsafe extern "C" fn(u32, u32, *mut u32),
    pub transform_feedback_buffer_base: unsafe extern "C" fn(u32, u32, u32),
    pub transform_feedback_buffer_range: unsafe extern "C" fn(u32, u32, u32, isize, isize),
    pub get_transform_feedback_iv: unsafe extern "C" fn(u32, u32, *mut i32),
    pub uniform_1ui: unsafe extern "C" fn(i32, u32),
    pub uniform_2ui: unsafe extern "C" fn(i32, u32, u32),
    pub uniform_3ui: unsafe extern "C" fn(i32, u32, u32, u32),
    pub uniform_4ui: unsafe extern "C" fn(i32, u32, u32, u32, u32),
    pub uniform_1uiv: unsafe extern "C" fn(i32, i32, *const u32),
    pub uniform_2uiv: unsafe extern "C" fn(i32, i32, *const u32),
    pub uniform_3uiv: unsafe extern "C" fn(i32, i32, *const u32),
    pub uniform_4uiv: unsafe extern "C" fn(i32, i32, *const u32),
    pub get_uniform_uiv: unsafe extern "C" fn(u32, i32, *mut u32),
    pub is_vertex_array: unsafe extern "C" fn(u32) -> u8,
    pub get_vertex_attrib_iv: unsafe extern "C" fn(u32, u32, *mut i32),
    pub get_vertex_attrib_i_iv: unsafe extern "C" fn(u32, u32, *mut i32),
    pub get_vertex_attrib_i_uiv: unsafe extern "C" fn(u32, u32, *mut u32),
    pub get_vertex_attrib_pointer_v: unsafe extern "C" fn(u32, u32, *mut *mut c_void),
    pub get_tex_parameter_fv: unsafe extern "C" fn(u32, u32, *mut f32),
    pub get_tex_parameter_i_iv: unsafe extern "C" fn(u32, u32, *mut i32),
    pub get_tex_parameter_i_uiv: unsafe extern "C" fn(u32, u32, *mut u32),
    pub get_tex_level_parameter_fv: unsafe extern "C" fn(u32, i32, u32, *mut f32),
    pub get_internalformat_iv: unsafe extern "C" fn(u32, u32, u32, i32, *mut i32),
    pub get_framebuffer_parameter_iv: unsafe extern "C" fn(u32, u32, *mut i32),
    pub get_renderbuffer_parameter_iv: unsafe extern "C" fn(u32, u32, *mut i32),
    pub get_multisample_fv: unsafe extern "C" fn(u32, u32, *mut f32),
    pub get_buffer_parameter_i64v: unsafe extern "C" fn(u32, u32, *mut i64),
    pub get_pointer_v: unsafe extern "C" fn(u32, *mut *mut c_void),
    pub sample_coverage: unsafe extern "C" fn(f32, u8),
    pub sample_mask_i: unsafe extern "C" fn(u32, u32),
    pub blend_color: unsafe extern "C" fn(f32, f32, f32, f32),
    pub point_parameter_fv: unsafe extern "C" fn(u32, *const f32),
    pub hint: unsafe extern "C" fn(u32, u32),
    pub copy_tex_image_2d: unsafe extern "C" fn(u32, i32, u32, i32, i32, i32, i32, i32),
    pub copy_tex_sub_image_2d: unsafe extern "C" fn(u32, i32, i32, i32, i32, i32, i32, i32),
    pub copy_tex_sub_image_3d: unsafe extern "C" fn(u32, i32, i32, i32, i32, i32, i32, i32, i32),
...
impl GlesDispatch {
    ...
    pub fn all_stub() -> Self {
        Self {
            ...
            sampler_parameter_i_iv: stub!(),
            sampler_parameter_i_uiv: stub!(),
            get_sampler_parameter_iv: stub!(),
            get_sampler_parameter_fv: stub!(),
            get_sampler_parameter_i_iv: stub!(),
            get_sampler_parameter_i_uiv: stub!(),
            transform_feedback_buffer_base: stub!(),
            transform_feedback_buffer_range: stub!(),
            get_transform_feedback_iv: stub!(),
            uniform_1ui: stub!(),
            uniform_2ui: stub!(),
            uniform_3ui: stub!(),
            uniform_4ui: stub!(),
            ...
            uniform_3uiv: stub!(),
            uniform_4uiv: stub!(),
            get_uniform_uiv: stub!(),
            is_vertex_array: stub!(),
            get_vertex_attrib_iv: stub!(),
            get_vertex_attrib_i_iv: stub!(),
            get_vertex_attrib_i_uiv: stub!(),
            get_vertex_attrib_pointer_v: stub!(),
            get_tex_parameter_fv: stub!(),
            get_tex_parameter_i_iv: stub!(),
            get_tex_parameter_i_uiv: stub!(),
            get_tex_level_parameter_fv: stub!(),
            get_internalformat_iv: stub!(),
            get_framebuffer_parameter_iv: stub!(),
            get_renderbuffer_parameter_iv: stub!(),
            get_multisample_fv: stub!(),
            get_buffer_parameter_i64v: stub!(),
            get_pointer_v: stub!(),
            sample_coverage: stub!(),
            sample_mask_i: stub!(),
            blend_color: stub!(),
            point_parameter_fv: stub!(),
            hint: stub!(),
            copy_tex_image_2d: stub!(),
            copy_tex_sub_image_2d: stub!(),
            copy_tex_sub_image_3d: stub!(),
    ...
    pub fn load_from(loader: &super::loader::GlesLoader) -> Option<Self> {
        ...
        Some(Self {
            ...
            sampler_parameter_i_iv: unsafe { std::mem::transmute(load!("glSamplerParameterIiv")) },
            sampler_parameter_i_uiv: unsafe { std::mem::transmute(load!("glSamplerParameterIuiv")) },
            get_sampler_parameter_iv: unsafe { std::mem::transmute(load!("glGetSamplerParameteriv")) },
            get_sampler_parameter_fv: unsafe { std::mem::transmute(load!("glGetSamplerParameterfv")) },
            get_sampler_parameter_i_iv: unsafe { std::mem::transmute(load!("glGetSamplerParameterIiv")) },
            get_sampler_parameter_i_uiv: unsafe { std::mem::transmute(load!("glGetSamplerParameterIuiv")) },
            transform_feedback_buffer_base: unsafe { std::mem::transmute(load!("glTransformFeedbackBufferBase")) },
            transform_feedback_buffer_range: unsafe { std::mem::transmute(load!("glTransformFeedbackBufferRange")) },
            get_transform_feedback_iv: unsafe { std::mem::transmute(load!("glGetTransformFeedbackiv")) },
            uniform_1ui: unsafe { std::mem::transmute(load!("glUniform1ui")) },
            uniform_2ui: unsafe { std::mem::transmute(load!("glUniform2ui")) },
            uniform_3ui: unsafe { std::mem::transmute(load!("glUniform3ui")) },
            uniform_4ui: unsafe { std::mem::transmute(load!("glUniform4ui")) },
            uniform_1uiv: unsafe { std::mem::transmute(load!("glUniform1uiv")) },
            uniform_2uiv: unsafe { std::mem::transmute(load!("glUniform2uiv")) },
            uniform_3uiv: unsafe { std::mem::transmute(load!("glUniform3uiv")) },
            uniform_4uiv: unsafe { std::mem::transmute(load!("glUniform4uiv")) },
            get_uniform_uiv: unsafe { std::mem::transmute(load!("glGetUniformuiv")) },
            is_vertex_array: unsafe { std::mem::transmute(load!("glIsVertexArray")) },
            get_vertex_attrib_iv: unsafe { std::mem::transmute(load!("glGetVertexAttribiv")) },
            get_vertex_attrib_i_iv: unsafe { std::mem::transmute(load!("glGetVertexAttribIiv")) },
            get_vertex_attrib_i_uiv: unsafe { std::mem::transmute(load!("glGetVertexAttribIuiv")) },
            get_vertex_attrib_pointer_v: unsafe { std::mem::transmute(load!("glGetVertexAttribPointerv")) },
            get_tex_parameter_fv: unsafe { std::mem::transmute(load!("glGetTexParameterfv")) },
            get_tex_parameter_i_iv: unsafe { std::mem::transmute(load!("glGetTexParameterIiv")) },
            get_tex_parameter_i_uiv: unsafe { std::mem::transmute(load!("glGetTexParameterIuiv")) },
            get_tex_level_parameter_fv: unsafe { std::mem::transmute(load!("glGetTexLevelParameterfv")) },
            get_internalformat_iv: unsafe { std::mem::transmute(load!("glGetInternalformativ")) },
            get_framebuffer_parameter_iv: unsafe { std::mem::transmute(load!("glGetFramebufferParameteriv")) },
            get_renderbuffer_parameter_iv: unsafe { std::mem::transmute(load!("glGetRenderbufferParameteriv")) },
            get_multisample_fv: unsafe { std::mem::transmute(load!("glGetMultisamplefv")) },
            get_buffer_parameter_i64v: unsafe { std::mem::transmute(load!("glGetBufferParameteri64v")) },
            get_pointer_v: unsafe { std::mem::transmute(load!("glGetPointerv")) },
            sample_coverage: unsafe { std::mem::transmute(load!("glSampleCoverage")) },
            sample_mask_i: unsafe { std::mem::transmute(load!("glSampleMaski")) },
            blend_color: unsafe { std::mem::transmute(load!("glBlendColor")) },
            point_parameter_fv: unsafe { std::mem::transmute(load!("glPointParameterfv")) },
            hint: unsafe { std::mem::transmute(load!("glHint")) },
            copy_tex_image_2d: unsafe { std::mem::transmute(load!("glCopyTexImage2D")) },
            copy_tex_sub_image_2d: unsafe { std::mem::transmute(load!("glCopyTexSubImage2D")) },
            copy_tex_sub_image_3d: unsafe { std::mem::transmute(load!("glCopyTexSubImage3D")) },
