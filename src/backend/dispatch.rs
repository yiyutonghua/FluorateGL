...
impl GlesDispatch {
    ...
    pub fn load_from(loader: &super::loader::GlesLoader) -> Option<Self> {
        ...
        Some(Self {
            ...
            sampler_parameter_i_iv: load_opt!("glSamplerParameterIiv"),
            sampler_parameter_i_uiv: load_opt!("glSamplerParameterIuiv"),
            get_sampler_parameter_iv: load_opt!("glGetSamplerParameteriv"),
            get_sampler_parameter_fv: load_opt!("glGetSamplerParameterfv"),
            get_sampler_parameter_i_iv: load_opt!("glGetSamplerParameterIiv"),
            get_sampler_parameter_i_uiv: load_opt!("glGetSamplerParameterIuiv"),
            // GL 4.0 函数（GLES 无对应）——可选加载，stub 时导出层降级/忽略
            transform_feedback_buffer_base: load_opt!("glTransformFeedbackBufferBase"),
            // GL 4.0 函数（GLES 无对应）——可选加载，stub 时导出层降级/忽略
            transform_feedback_buffer_range: load_opt!("glTransformFeedbackBufferRange"),
            // GL 4.0 函数（GLES 无对应）——可选加载，stub 时导出层降级/忽略
            get_transform_feedback_iv: load_opt!("glGetTransformFeedbackiv"),
            uniform_1ui: load_opt!("glUniform1ui"),
            uniform_2ui: load_opt!("glUniform2ui"),
            uniform_3ui: load_opt!("glUniform3ui"),
            uniform_4ui: load_opt!("glUniform4ui"),
            uniform_1uiv: load_opt!("glUniform1uiv"),
            uniform_2uiv: load_opt!("glUniform2uiv"),
            uniform_3uiv: load_opt!("glUniform3uiv"),
            uniform_4uiv: load_opt!("glUniform4uiv"),
            get_uniform_uiv: load_opt!("glGetUniformuiv"),
            is_vertex_array: load_opt!("glIsVertexArray"),
            get_vertex_attrib_iv: load_opt!("glGetVertexAttribiv"),
            get_vertex_attrib_i_iv: load_opt!("glGetVertexAttribIiv"),
            get_vertex_attrib_i_uiv: load_opt!("glGetVertexAttribIuiv"),
            get_vertex_attrib_pointer_v: load_opt!("glGetVertexAttribPointerv"),
            get_tex_parameter_fv: load_opt!("glGetTexParameterfv"),
            get_tex_parameter_i_iv: load_opt!("glGetTexParameterIiv"),
            get_tex_parameter_i_uiv: load_opt!("glGetTexParameterIuiv"),
            get_tex_level_parameter_fv: load_opt!("glGetTexLevelParameterfv"),
            get_internalformat_iv: load_opt!("glGetInternalformativ"),
            get_framebuffer_parameter_iv: load_opt!("glGetFramebufferParameteriv"),
            get_renderbuffer_parameter_iv: load_opt!("glGetRenderbufferParameteriv"),
            get_multisample_fv: load_opt!("glGetMultisamplefv"),
            get_buffer_parameter_i64v: load_opt!("glGetBufferParameteri64v"),
            get_pointer_v: load_opt!("glGetPointerv"),
            sample_coverage: load_opt!("glSampleCoverage"),
            sample_mask_i: load_opt!("glSampleMaski"),
            blend_color: load_opt!("glBlendColor"),
            point_parameter_fv: load_opt!("glPointParameterfv"),
            hint: load_opt!("glHint"),
            copy_tex_image_2d: load_opt!("glCopyTexImage2D"),
            copy_tex_sub_image_2d: load_opt!("glCopyTexSubImage2D"),
            copy_tex_sub_image_3d: load_opt!("glCopyTexSubImage3D"),
